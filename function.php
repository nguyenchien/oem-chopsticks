...
function resizeImage($resourceType, $imageWidth, $imageHeight){
    ...
    function send($mail_product, $mail_client, $subject, $content){
        ...
        try {
            ...
            //$PHPMailer->Host = 'smtp9.gmoserver.jp';
            ...
            //$PHPMailer->setFrom('produce-ml@wagokoro.co.jp', '箸のOEM製造・製作なら 株式会社和心へ');
            $PHPMailer->setFrom('chiennguyen1702@gmail.com', '箸のOEM製造・製作なら 株式会社和心へ');
